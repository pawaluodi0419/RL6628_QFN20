...
u8 _by_Pattern0_Setup_dut2()
{
	...
	case 0x0000:
	{
		...
		XGpio_2_WriteBit(0,dut2_FT2_PWR_CTRL_OFFSET,0x01);	//S0-PWR_EN: 控制S0-ATX_5V是否开出S0-5V（未经过采样电阻）
		msdelay(5);
		XGpio_WriteBit(XPAR_AXI_GPIO_dut2_1_BASEADDR,0,1, 1);	//S0-PWR_EN_2: 控制S0-5V是否开出S0-5V_IN/S0-VCON_IN
		msdelay(5);
	...
	case 0x0003:
	{
		...
		else
		{
			...
			//xil_printf("dut2.read_icstatus_data[0] =0x%x\r\n", read_icstatus_data[0]);
			//xil_printf("dut2.read_icstatus_data[1] =0x%x\r\n", read_icstatus_data[1]);
			//xil_printf("dut2.read_icstatus_data[2] =0x%x\r\n", read_icstatus_data[2]);
			//xil_printf("dut2.read_icstatus_data[3] =0x%x\r\n", read_icstatus_data[3]);
			//xil_printf("dut2.read_icstatus_data[4] =0x%x\r\n", read_icstatus_data[4]);
			//xil_printf("dut2.read_icstatus_data[5] =0x%x\r\n", read_icstatus_data[5]);
			//xil_printf("dut2.read_icstatus_data[6] =0x%x\r\n", read_icstatus_data[6]);
			//xil_printf("dut2.read_icstatus_data[7] =0x%x\r\n", read_icstatus_data[7]);
			//xil_printf("dut2.read_icstatus_data[8] =0x%x\r\n", read_icstatus_data[8]);
			//xil_printf("dut2.read_icstatus_data[9] =0x%x\r\n", read_icstatus_data[9]);
			//xil_printf("dut2.read_icstatus_data[10] =0x%x\r\n", read_icstatus_data[10]);
			...
			else
			{
			    ...
			    xil_printf("dut2 get ic inf fail!!!\r\n\r\n");
			}
			for(i=0; i<31; i++)
			{
	...
	case 0x0004:
	{
		   ...
		   ////////////xil_printf("dut2_pattern0_efuse_clock_enable\r\n\r\n");
	break;
	}

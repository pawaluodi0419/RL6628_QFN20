...
u8 _by_Pattern0_Setup_dut3()
{
	...
	case 0x0003:
	{
		...
		else
		{
			...
			//xil_printf("dut3.read_icstatus_data[0] =0x%x\r\n", read_icstatus_data[0]);
			//xil_printf("dut3.read_icstatus_data[1] =0x%x\r\n", read_icstatus_data[1]);
			//xil_printf("dut3.read_icstatus_data[2] =0x%x\r\n", read_icstatus_data[2]);
			...
			//xil_printf("dut3.read_icstatus_data[5] =0x%x\r\n", read_icstatus_data[5]);
			//xil_printf("dut3.read_icstatus_data[6] =0x%x\r\n", read_icstatus_data[6]);
			//xil_printf("dut3.read_icstatus_data[7] =0x%x\r\n", read_icstatus_data[7]);
			//xil_printf("dut3.read_icstatus_data[8] =0x%x\r\n", read_icstatus_data[8]);
			//xil_printf("dut3.read_icstatus_data[9] =0x%x\r\n", read_icstatus_data[9]);
			//xil_printf("dut3.read_icstatus_data[10] =0x%x\r\n", read_icstatus_data[10]);
			...
			else
			{
			    ...
			    xil_printf("dut3 get ic inf fail!!!\r\n\r\n");
			}
			for(i=0; i<31; i++)
			{
	...
	case 0x0004:
	{
		   ...
		   ////////////xil_printf("dut3_pattern0_efuse_clock_enable\r\n\r\n");
	break;
	}

...
u8 _by_Pattern2_ADCcalibration_dut0()
{
	...
	case 0x0000:
	{
		...
		{
			dut0.g_vmon_temp_voltage[0] = dut0.g_pattern_smbus_control_buf[10];		//低8位
			dut0.g_vmon_temp_voltage[1] = dut0.g_pattern_smbus_control_buf[11];		//高8位
			//xil_printf("dut0.g_vmon_temp_voltage[0] =%x\r\n", dut0.g_vmon_temp_voltage[0]);
			//xil_printf("dut0.g_vmon_temp_voltage[1] =%x\r\n", dut0.g_vmon_temp_voltage[1]);
	...
	******************************************/
	...
	case 0x0003:
	{
		...
		else
		{
			...
			if((dut0.g_vmon_writeefuse_600mv[0]>VMON_Efuse_Min)&&(dut0.g_vmon_writeefuse_600mv[0]<VMON_Efuse_Max))
			{
				for(i=0;i<4;i++)
				{
			...
			else
			{
				...
				xil_printf("dut0.g_vmon_writeefuse_600mv[0] =%x VMON_Efuse_Min =%x VMON_Efuse_Max =%x\r\n",dut0.g_vmon_writeefuse_600mv[0],VMON_Efuse_Min,VMON_Efuse_Max);
				xil_printf("dut0.g_vmon_writeefuse fail, not fit spec!\r\n");
			}
		}
		break;
	}
	...
	case 0x0004:
	{
		...
		xil_printf("dut0_pattern2_adc_vmon_calibration_pass! vmon_calibration_data= 0x%x\r\n\r\n",dut0.g_vmon_writeefuse_600mv[0]);

...
//dut2 Pattern 2：RP Calibration and test
u8 _by_Pattern2_ADCcalibration_dut2()
{
	...
	case 0x0000:
	{
		   ...
		   {
			   dut2.g_vmon_temp_voltage[0] = dut2.g_pattern_smbus_control_buf[10];
			   dut2.g_vmon_temp_voltage[1] = dut2.g_pattern_smbus_control_buf[11];
	...
	case 0x0003:
	{
		...
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut2.g_vmon_calib_voltage);
		...
		else
		{
			...
			dut2.g_pattern_step++;
			////xil_printf("dut2.g_vmon_compare_step = %x\r\n",dut2.g_vmon_compare_step);
			//xil_printf("dut2_pattern5_CC1_0.66V_Calibration\r\n");
			...
			//xil_printf("dut2_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0004:
	{
		dut2.g_vmon_calib_level = vmon_calib_1000mv;
		dut2.g_vmon_calib_voltage = 1000;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut2.g_vmon_calib_voltage);
		_vmon_calibration_dut2();
		...
		{
			dut2.g_vmon_writeefuse_1000mv[0] = dut2.g_vmon_calibration_data_buf[2];
			dut2.g_vmon_writeefuse_1000mv[1] = dut2.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut2.g_vmon_calibration_data_buf[i] = 0;
			}
			...
			////xil_printf("dut2.g_vmon_compare_step = %x\r\n",dut2.g_vmon_compare_step);
			//xil_printf("dut2_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut2.g_vmon_writeefuse_1000mv[0] = %x\r\n",dut2.g_vmon_writeefuse_1000mv[0]);
			//xil_printf("dut2.g_vmon_writeefuse_1000mv[1] = %x\r\n",dut2.g_vmon_writeefuse_1000mv[1]);
		}
			//xil_printf("dut2_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0005:
	{
		dut2.g_vmon_calib_level = vmon_calib_2500mv;
		dut2.g_vmon_calib_voltage = 2500;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut2.g_vmon_calib_voltage);
		_vmon_calibration_dut2();
		...
		{
			dut2.g_vmon_writeefuse_2500mv[0] = dut2.g_vmon_calibration_data_buf[2];
			dut2.g_vmon_writeefuse_2500mv[1] = dut2.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut2.g_vmon_calibration_data_buf[i] = 0;
			}
			...
			////xil_printf("dut2.g_vmon_compare_step = %x\r\n",dut2.g_vmon_compare_step);
			//xil_printf("dut2_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut2.g_vmon_writeefuse_2500mv[0] = %x\r\n",dut2.g_vmon_writeefuse_2500mv[0]);
			//xil_printf("dut2.g_vmon_writeefuse_2500mv[1] = %x\r\n",dut2.g_vmon_writeefuse_2500mv[1]);
		}
			//xil_printf("dut2_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0006:
	{
		dut2.g_vmon_calib_level = vmon_calib_3000mv;
		dut2.g_vmon_calib_voltage = 3000;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut2.g_vmon_calib_voltage);
		_vmon_calibration_dut2();
		...
		{
			dut2.g_vmon_writeefuse_3000mv[0] = dut2.g_vmon_calibration_data_buf[2];
			dut2.g_vmon_writeefuse_3000mv[1] = dut2.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut2.g_vmon_calibration_data_buf[i] = 0;
			}
			...
			////xil_printf("dut2.g_vmon_compare_step = %x\r\n",dut2.g_vmon_compare_step);
			//xil_printf("dut2_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut2.g_vmon_writeefuse_3000mv[0] = %x\r\n",dut2.g_vmon_writeefuse_3000mv[0]);
			//xil_printf("dut2.g_vmon_writeefuse_3000mv[1] = %x\r\n",dut2.g_vmon_writeefuse_3000mv[1]);
		}
			//xil_printf("dut2_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	//xil_printf("dut2_pattern2_adcvmon_step = %x\r\n",dut2.g_pattern_step);
	return 0;
}

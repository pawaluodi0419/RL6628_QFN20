...
u8 _by_Pattern2_ADCcalibration_dut3()
{
	...
	case 0x0000:
	{
		...
		{
			dut3.g_vmon_temp_voltage[0] = dut3.g_pattern_smbus_control_buf[10];		//低8位
			dut3.g_vmon_temp_voltage[1] = dut3.g_pattern_smbus_control_buf[11];		//高8位
			//xil_printf("dut3.g_vmon_temp_voltage[0] =%x\r\n", dut3.g_vmon_temp_voltage[0]);
			//xil_printf("dut3.g_vmon_temp_voltage[1] =%x\r\n", dut3.g_vmon_temp_voltage[1]);
	...
	******************************************/
	...
	case 0x0003:
	{
		...
		else
		{
			...
			if((dut3.g_vmon_writeefuse_600mv[0]>VMON_Efuse_Min)&&(dut3.g_vmon_writeefuse_600mv[0]<VMON_Efuse_Max))
			{
				for(i=0;i<4;i++)
				{
			...
			else
			{
				...
				xil_printf("dut3.g_vmon_writeefuse_600mv[0] =%x VMON_Efuse_Min =%x VMON_Efuse_Max =%x\r\n",dut3.g_vmon_writeefuse_600mv[0],VMON_Efuse_Min,VMON_Efuse_Max);
				xil_printf("dut3.g_vmon_writeefuse fail, not fit spec!\r\n");
			}
		}
		break;
	}

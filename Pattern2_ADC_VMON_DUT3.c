...
//dut3 Pattern 2：RP Calibration and test
u8 _by_Pattern2_ADCcalibration_dut3()
{
	u8 i;
	u16 adc_code;
	...
	case 0x0000:
	{
		   ...
		   {
			   dut3.g_vmon_temp_voltage[0] = dut3.g_pattern_smbus_control_buf[10];
			   dut3.g_vmon_temp_voltage[1] = dut3.g_pattern_smbus_control_buf[11];
			   //xil_printf("dut3.g_pattern_smbus_control_buf[10] =%x\r\n", dut3.g_pattern_smbus_control_buf[10]);
			   //xil_printf("dut3.g_vmon_temp_voltage[0] =%x\r\n", dut3.g_vmon_temp_voltage[0]);
			   for(i=0; i<31; i++)
			   {
	...
	case 0x0001:
	{
	   ...
	   dut3.g_pattern_smbus_control_buf[3] = 0x10;
	   dut3.g_pattern_smbus_control_buf[4] = 0x01;
	   dut3.g_pattern_smbus_control_buf[5] = (dut3.g_vmon_temp_voltage[0] |(1<<7));
	...
	case 0x0002:
	{
		   ...
		   {
			   dut3.g_vmon_temp_voltage[2] = dut3.g_pattern_smbus_control_buf[10];
			   //xil_printf("dut3.g_pattern_smbus_control_buf[10] =%x\r\n", dut3.g_pattern_smbus_control_buf[10]);
			   //xil_printf("dut3.g_vmon_temp_voltage[2] =%x\r\n", dut3.g_vmon_temp_voltage[2]);
	...
	case 0x0003:
	{
		dut3.g_vmon_calib_level = vmon_calib_600mv;
		dut3.g_vmon_calib_voltage = 600;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut3.g_vmon_calib_voltage);
		_vmon_calibration_dut3();

		//xil_printf("dut3.g_vmon_compare_step = %x\r\n",dut3.g_vmon_compare_step);
		//xil_printf("dut3.g_pattern_step = %x\r\n",dut3.g_pattern_step);
		if(dut3.g_vmoncompare_process_bit != vmon_process_done_pass)
		{

		}
		else
		{
			dut3.g_vmon_writeefuse_600mv[0] = dut3.g_vmon_calibration_data_buf[2];
			dut3.g_vmon_writeefuse_600mv[1] = dut3.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut3.g_vmon_calibration_data_buf[i] = 0;
			}
			   dut3.g_vmoncompare_process_bit = vmon_process_waiting;
			   dut3.g_vmon_compare_step = 0;
			dut3.g_pattern_step++;
			////xil_printf("dut3.g_vmon_compare_step = %x\r\n",dut3.g_vmon_compare_step);
			//xil_printf("dut3_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut3.g_vmon_writeefuse_600mv[0] = %x\r\n",dut3.g_vmon_writeefuse_600mv[0]);
			//xil_printf("dut3.g_vmon_writeefuse_600mv[1] = %x\r\n",dut3.g_vmon_writeefuse_600mv[1]);
		}
			//xil_printf("dut3_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0004:
	{
		dut3.g_vmon_calib_level = vmon_calib_1000mv;
		dut3.g_vmon_calib_voltage = 1000;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut3.g_vmon_calib_voltage);
		_vmon_calibration_dut3();
		...
		{
			dut3.g_vmon_writeefuse_1000mv[0] = dut3.g_vmon_calibration_data_buf[2];
			dut3.g_vmon_writeefuse_1000mv[1] = dut3.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut3.g_vmon_calibration_data_buf[i] = 0;
			}
			...
			////xil_printf("dut3.g_vmon_compare_step = %x\r\n",dut3.g_vmon_compare_step);
			//xil_printf("dut3_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut3.g_vmon_writeefuse_1000mv[0] = %x\r\n",dut3.g_vmon_writeefuse_1000mv[0]);
			//xil_printf("dut3.g_vmon_writeefuse_1000mv[1] = %x\r\n",dut3.g_vmon_writeefuse_1000mv[1]);
		}
			//xil_printf("dut3_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0005:
	{
		dut3.g_vmon_calib_level = vmon_calib_2500mv;
		dut3.g_vmon_calib_voltage = 2500;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut3.g_vmon_calib_voltage);
		_vmon_calibration_dut3();
		...
		{
			dut3.g_vmon_writeefuse_2500mv[0] = dut3.g_vmon_calibration_data_buf[2];
			dut3.g_vmon_writeefuse_2500mv[1] = dut3.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut3.g_vmon_calibration_data_buf[i] = 0;
			}
			...
			////xil_printf("dut3.g_vmon_compare_step = %x\r\n",dut3.g_vmon_compare_step);
			//xil_printf("dut3_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut3.g_vmon_writeefuse_2500mv[0] = %x\r\n",dut3.g_vmon_writeefuse_2500mv[0]);
			//xil_printf("dut3.g_vmon_writeefuse_2500mv[1] = %x\r\n",dut3.g_vmon_writeefuse_2500mv[1]);
		}
			//xil_printf("dut3_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0006:
	{
		dut3.g_vmon_calib_level = vmon_calib_3000mv;
		dut3.g_vmon_calib_voltage = 3000;
		//i2c_max5825_output(SMBUS_DEV0_ADDR,MAX5825_DEV0_SLAVE_ADDR,5,dut3.g_vmon_calib_voltage);
		_vmon_calibration_dut3();
		...
		{
			dut3.g_vmon_writeefuse_3000mv[0] = dut3.g_vmon_calibration_data_buf[2];
			dut3.g_vmon_writeefuse_3000mv[1] = dut3.g_vmon_calibration_data_buf[3];
			for(i=0;i<4;i++)
			{
				dut3.g_vmon_calibration_data_buf[i] = 0;
			}
			...
			////xil_printf("dut3.g_vmon_compare_step = %x\r\n",dut3.g_vmon_compare_step);
			//xil_printf("dut3_pattern5_CC1_0.66V_Calibration\r\n");
			//xil_printf("dut3.g_vmon_writeefuse_3000mv[0] = %x\r\n",dut3.g_vmon_writeefuse_3000mv[0]);
			//xil_printf("dut3.g_vmon_writeefuse_3000mv[1] = %x\r\n",dut3.g_vmon_writeefuse_3000mv[1]);
		}
			//xil_printf("dut3_pattern2_adcvmon_Calibration\r\n");
		    break;
	}
	...
	case 0x0007:
	{
			...
			for(i=1; i<31; i++)
		   {
		       ...
		       result_output_for_v50(XPAR_AXI_GPIO_dut3_1_BASEADDR,dut3.g_uartPatternNum);
			    ...
			    xil_printf("dut3_pattern2_adc_vmon_calibration_pass! vmon_calibration_data= 0x%x\r\n\r\n",dut3.g_vmon_writeefuse_1000mv[0]);
	...
	if(dut3.g_result_fail == 0x01)
	{
		...
		xil_printf("dut3_pattern2_fail! fail_step = %x\r\n\r\n",dut3.g_pattern_step);
	}
	//xil_printf("dut3_pattern2_adcvmon_step = %x\r\n",dut3.g_pattern_step);
	return 0;
}

...
//dut2 Pattern 3£ºRP Calibration and test
u8 _by_Pattern3_RPcalibration_dut2()
{
	...
	case 0x0100:
	{
		   ...
		   //////////////xil_printf("\r\n dut2_pattern3_0xC1AE_be_writen\r\n");
	...
	case 0x0101:
	{
		   ...
		   //////////////xil_printf("dut2_pattern3_0xC108_be_writen\r\n");
		   //////xil_printf("dut2_pattern3_step = %x\r\n", dut2.g_pattern_step);
		   break;
	}
	...
	case 0x0102:
	{
		   ...
		   //////xil_printf("dut2_pattern3_step = %x\r\n", dut2.g_pattern_step);
		   //////////////xil_printf("dut2_pattern3_0x1022/1023_be_writen\r\n\r\n");
		   break;
	}
	...
	case 0x0103:
	{
		...
		//////xil_printf("dut2_pattern3_write_0x1131_with_0xc0\r\n");
		break;
	}
	   /****************************************
	...
	case 0x0200:
	{
    	...
    	dut2.g_pattern_step++;
		//////////////xil_printf("dut2_pattern3_read_LDO3V3\r\n\r\n");
    	//////xil_printf("dut2_pattern3_step = %x\r\n", dut2.g_pattern_step);
		break;
	}
	...
	case 0x0201:
	{
    	...
    	//////xil_printf("dut2_pattern3_step = %x\r\n", dut2.g_pattern_step);
    	//////////////xil_printf("dut2_pattern3_write_0x106_default_data\r\n");
		break;
	}
	...
	case 0x0202:
	{
    	...
    	dut2.g_pattern_step++;
    	//////xil_printf("dut2_pattern3_step = %x\r\n", dut2.g_pattern_step);
    	//////////////xil_printf("dut2_pattern3_read_cc1_rp12k_default_voltage\r\n");
    	break;
	}
	...
	case 0x0203:
	{
		...
		else
		{
		   ...
		   //////xil_printf("dut2_pattern3_step = %x\r\n", dut2.g_pattern_step);
		//////////////xil_printf("dut2_pattern3_write_cc1_rp12k_0x106\r\n");
		break;
	}
    	...
    	if((dut2.g_dut_pattern_status_buf[31] >= 0) && (dut2.g_dut_pattern_status_buf[31]<= 0x0F))
    	{
    		...
    		else if(cc1_rp_voltage < rp12k_ref)
    		{
				...
				dut2.g_pattern_step++;
    				...
    				//////////////xil_printf("dut2_pattern3_read_cc1_rp12k_calibration_voltage\r\n");
			    break;
    			}
	...
	case 0x0205:
	{
		   ...
		   ////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
		   //////////////xil_printf("dut2_pattern3_write_cc1_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0206:
	{
		   ...
		   //////////////xil_printf("dut2_pattern3_read_cc1_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0300:
	{
		  ...
		  smbus2_irq_handle(dut2.g_pattern_smbus_control_buf);
		   ...
		   ////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
		   //////////////xil_printf("dut2_pattern3_write_cc2_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0301:
	{
    	...
    	rp12k_max = (u16)(dut2.g_dut_pattern_status_buf[16]<<8 | dut2.g_dut_pattern_status_buf[15]);
	       ...
	       //////////////xil_printf("rp12k_max = %d\r\n",rp12k_max );
			...
			////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
			//////////////xil_printf("dut2_pattern3_read_cc2_rp12k_voltage\r\n");
			break;
	}
	}

...
//dut3 Pattern 3£ºRP Calibration and test
u8 _by_Pattern3_RPcalibration_dut3()
{
	u8 i;
	u16 voltage_ldo3v3;
	u16 rp12k_ref;
	...
	case 0x0100:
	{
		   ...
		   //////////////xil_printf("\r\n dut3_pattern3_0xC1AE_be_writen\r\n");
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		   break;
	}
	...
	case 0x0101:
	{
		   ...
		   //////////////xil_printf("dut3_pattern3_0xC108_be_writen\r\n");
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		   break;
	}
	...
	case 0x0102:
	{
		   ...
		   dut3.g_pattern_smbus_control_buf[5] = 0x46;
		   dut3.g_pattern_smbus_control_buf[6] = 0x46;
		   ...
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern3_0x1022/1023_be_writen\r\n\r\n");
		   break;
	}
	...
	case 0x0103:
	{
		...
		//////xil_printf("dut3_pattern3_write_0x1131_with_0xc0\r\n");
		break;
	}
	   /****************************************
	...
	case 0x0200:
	{
    	...
    	dut3.g_dut_pattern_status_buf[11] = (rp12k_ref & 0xFF);
    	dut3.g_dut_pattern_status_buf[12] = (rp12k_ref & 0xFF00)>>8;
    	dut3.g_dut_pattern_status_buf[13] = (rp12k_min & 0xFF);
    	dut3.g_dut_pattern_status_buf[14] = (rp12k_min & 0xFF00)>>8;
    	dut3.g_dut_pattern_status_buf[15] = (rp12k_max & 0xFF);
    	dut3.g_dut_pattern_status_buf[16] = (rp12k_max & 0xFF00)>>8;

    	dut3.g_pattern_step++;
		//////////////xil_printf("dut3_pattern3_read_LDO3V3\r\n\r\n");
    	//////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		break;
	}
	...
	case 0x0201:
	{
    	...
    	dut3.g_pattern_smbus_control_buf[2] = 0x0c;
    	...
    	//////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
    	//////////////xil_printf("dut3_pattern3_write_0x106_default_data\r\n");
		break;
	}
	...
	case 0x0202:
	{
    	...
    	rp12k_ref = (u16)(dut3.g_dut_pattern_status_buf[12]<<8 | dut3.g_dut_pattern_status_buf[11]);
    	rp12k_min = (u16)(dut3.g_dut_pattern_status_buf[14]<<8 | dut3.g_dut_pattern_status_buf[13]);
    	rp12k_max = (u16)(dut3.g_dut_pattern_status_buf[16]<<8 | dut3.g_dut_pattern_status_buf[15]);
    	...
    	dut3.g_pattern_step++;
    	//////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
    	//////////////xil_printf("dut3_pattern3_read_cc1_rp12k_default_voltage\r\n");
    	break;
	}
	...
	case 0x0203:
	{
		...
		else
		{
		   ...
		   //////xil_printf("dut3_pattern3_step = %x\r\n", dut3.g_pattern_step);
		//////////////xil_printf("dut3_pattern3_write_cc1_rp12k_0x106\r\n");
		break;
	}
    	...
    	if((dut3.g_dut_pattern_status_buf[31] >= 0) && (dut3.g_dut_pattern_status_buf[31]<= 0x0F))
    	{
    		...
    		else if(cc1_rp_voltage < rp12k_ref)
    		{
				...
				dut3.g_pattern_step++;
    				...
    				//////////////xil_printf("dut3_pattern3_read_cc1_rp12k_calibration_voltage\r\n");
			    break;
    			}
	...
	case 0x0205:
	{
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern3_write_cc1_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0206:
	{
		   ...
		   {
		       cc1_rp12k_offset = (((dut3.g_pattern_smbus_control_buf[11] << 8) | (dut3.g_pattern_smbus_control_buf[10]))>>5)&0x1f;
		       if(cc1_rp12k_offset >= 0x0f)
		       {
		    	   dut3.g_dut_pattern_status_buf[30] = 0;
		    	   dut3.g_dut_pattern_status_buf[31] = cc1_rp12k_offset - 0x0f;
		    	   dut3.g_efuse_data_buf[4] = 1;
		    	   dut3.g_efuse_data_buf[5] = dut3.g_dut_pattern_status_buf[30];
		    	   dut3.g_efuse_data_buf[6] = dut3.g_dut_pattern_status_buf[31];
		       }
		       else if(cc1_rp12k_offset < 0x0f)
		       {
		    	   dut3.g_dut_pattern_status_buf[30] = 1;
		    	   dut3.g_dut_pattern_status_buf[31] = 0x0f- cc1_rp12k_offset;
		    	   dut3.g_efuse_data_buf[4] = 1;
		    	   dut3.g_efuse_data_buf[5] = dut3.g_dut_pattern_status_buf[30];
		    	   dut3.g_efuse_data_buf[6] = dut3.g_dut_pattern_status_buf[31];
		       }
					...
					//xil_printf("dut3_cc1_rp12k_offset =%x\r\n", cc1_rp12k_offset);
		   }
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   ...
		   //////////////xil_printf("cc1_rp12k_voltage =%d\r\n", cc1_rp_voltage);
		   //////////xil_printf("dut3.g_efuse_data_buf[5] =%x\r\n", dut3.g_efuse_data_buf[5]);
		   //////////xil_printf("dut3.g_efuse_data_buf[6] =%x\r\n", dut3.g_efuse_data_buf[6]);
		   //////////////xil_printf("dut3_pattern3_read_cc1_rp12k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0300:
	{
		  ...
		  smbus3_irq_handle(dut3.g_pattern_smbus_control_buf);
		   ...
		   ////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
		   //////////////xil_printf("dut3_pattern3_write_cc2_rp12k_calibration_0x106\r\n");
	break;
	}
    	...
    	rp12k_max = (u16)(dut3.g_dut_pattern_status_buf[16]<<8 | dut3.g_dut_pattern_status_buf[15]);
	       ...
	       //////////////xil_printf("rp12k_max = %d\r\n",rp12k_max );
			...
			if((cc2_rp_voltage > rp12k_min) && (cc2_rp_voltage < rp12k_max))
			{
				...
				xil_printf("dut3_pattern3_rp_test_pass!    rp12k_signbit= 0x%x  rp12k_offset=0x%x\r\n\r\n",dut3.g_efuse_data_buf[5],dut3.g_efuse_data_buf[6]);
			...
			////////////xil_printf("dut3_rp_g_pattern_step = %x\r\n", dut3.g_pattern_step);
			//////////////xil_printf("dut3_pattern3_read_cc2_rp12k_voltage\r\n");
			break;
	}
	}
	...
	if(dut3.g_result_fail == 0x01)
	{
		...
		xil_printf("dut3_pattern3_fail! fail_step = %x\r\n",dut3.g_pattern_step);
	    xil_printf("rp12k_min = %d rp12k_max = %d\r\n",rp12k_min, rp12k_max);
	    xil_printf("dut3_cc_rp_voltage = %d\r\n\r\n",cc_rp_voltage);
	}
	//xil_printf("dut3_pattern3_rp_step = 0x%x\r\n", dut3.g_pattern_step);
	return 0;
}

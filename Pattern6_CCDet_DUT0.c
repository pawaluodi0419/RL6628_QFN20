...
//dut0 Pattern 6£ºLDO3V3 Calibration and test
u8 _by_Pattern6_CCDet_dut0()
{
	...
	case 0x000e:
	{
		...
		dut0.g_ccdet_phy_calibration_bit         = 0;
		dut0.g_ccdet_ana_result_bit              = 7;
		////////xil_printf("\r\ndut0_pattern6_CC2_2.6V_Calibration_before01\r\n");
		////////xil_printf("dut0.g_pattern_step = %x\r\n",dut0.g_pattern_step);
		_ccdet_calibration_dut0();
		...
		else
		{
			...
			dut0.g_ccdet_step = 0;
			dut0.g_pattern_step = 0;
			dut0.g_dut_pattern_status_buf[2] = 0x0f;
			/*dut0.g_dut_pattern_status_buf[2] = 0;
   	   	    dut0.g_retest = 0;
   	   		for(i=0;i<20;i++)
   	   		{
		   ...
		   XGpio_2_WriteBit(0,DUT0_FT2_PWR_CTRL_OFFSET,0x01);*/
      		...
      		//xil_printf("dut0_pattern6_CC2_2.6V_Calibration\r\n\r\n\r\n");

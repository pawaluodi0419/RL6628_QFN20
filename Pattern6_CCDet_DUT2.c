...
//dut2 Pattern 6£ºLDO3V3 Calibration and test
u8 _by_Pattern6_CCDet_dut2()
{
	...
	case 0x000e:
	{
		...
		dut2.g_ccdet_phy_calibration_bit         = 0;
		dut2.g_ccdet_ana_result_bit              = 7;
		////////xil_printf("\r\ndut2_pattern6_CC2_2.6V_Calibration_before01\r\n");
		////////xil_printf("dut2.g_pattern_step = %x\r\n",dut2.g_pattern_step);
		_ccdet_calibration_dut2();
		...
		else
		{
			...
			dut2.g_ccdet_step = 0;
			dut2.g_pattern_step = 0;
			dut2.g_dut_pattern_status_buf[2] = 0x0f;
			/*dut2.g_dut_pattern_status_buf[2] = 0;
   	   	    dut2.g_retest = 0;
   	   		for(i=0;i<20;i++)
   	   		{
		   ...
		   XGpio_2_WriteBit(0,DUT0_FT2_PWR_CTRL_OFFSET,0x01);*/
      		...
      		//xil_printf("dut2_pattern6_CC2_2.6V_Calibration\r\n\r\n\r\n");

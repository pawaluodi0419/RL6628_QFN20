...
u8 _by_Pattern6_CCDet_dut3()
{
	...
	case 0x000e:
	{
		...
		dut3.g_ccdet_phy_calibration_bit         = 0;
		dut3.g_ccdet_ana_result_bit              = 7;
		////////xil_printf("\r\ndut3_pattern6_CC2_2.6V_Calibration_before01\r\n");
		////////xil_printf("dut3.g_pattern_step = %x\r\n",dut3.g_pattern_step);
		_ccdet_calibration_dut3();
		...
		else
		{
			...
			dut3.g_ccdet_step = 0;
			dut3.g_pattern_step = 0;
			dut3.g_dut_pattern_status_buf[2] = 0x0f;
			/*dut3.g_dut_pattern_status_buf[2] = 0;
   	   	    dut3.g_retest = 0;
   	   		for(i=0;i<20;i++)
   	   		{
		   ...
		   XGpio_2_WriteBit(0,DUT0_FT2_PWR_CTRL_OFFSET,0x01);*/
      		...
      		//xil_printf("dut3_pattern6_CC2_2.6V_Calibration\r\n\r\n\r\n");

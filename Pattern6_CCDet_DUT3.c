...
//dut3 Pattern 6£ºLDO3V3 Calibration and test
u8 _by_Pattern6_CCDet_dut3()
{
	u8 i;
	...
	case 0x0000:
	{
		...
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,19, 1);
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,20, 0);
		msdelay(5);

		//enable ADG1604
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,13, 1);	//S0-CC1_TEST_EN
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,14, 1);	//S0-CC2_TEST_EN
		msdelay(5);
		//select ADG1604 S1 channel
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,9, 0);	//S0-CC1_TEST_SEL0
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,10, 1);	//S0-CC1_TEST_SEL1

		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,24, 0);	//S0-CC2_TEST_SEL0
		XGpio_WriteBit(XPAR_AXI_GPIO_dut3_1_BASEADDR,0,27, 1);	//S0-CC2_TEST_SEL1
		msdelay(5);
	...
	case 0x0001:
	{
		...
		dut3.g_ccdet_phy_calibration_addr_buf[0] = 0x0f;
		dut3.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut3.g_ccdet_voltage_sel = 0x55;
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC1_0.2V_Calibration\r\n");
		    break;
	}
	...
	case 0x0002:
	{
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC2_0.2V_Calibration\r\n");
		    break;
	}
	...
	case 0x0003:
	{
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC1_0.4V_Calibration\r\n");
		    break;
	}
	...
	case 0x0004:
	{
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC2_0.4V_Calibration\r\n");
		    break;
	}
	...
	case 0x0005:
	{
		...
		dut3.g_ccdet_phy_calibration_addr_buf[0] = 0x10;
		dut3.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		...
		else
		{
			...
			////xil_printf("dut3.g_ccdet_calibration_data_buf[6] = %x\r\n",dut3.g_ccdet_calibration_data_buf[6]);
			////xil_printf("dut3.g_ccdet_calibration_data_buf[7] = %x\r\n",dut3.g_ccdet_calibration_data_buf[7]);
			for(i=0;i<4;i++)
			{
				dut3.g_ccdet_calibration_data_buf[i] = 0;
			}
			...
			dut3.g_pattern_step = 0;
			xil_printf("dut3.g_ccdet_step = %x\r\n",dut3.g_ccdet_step);
			////xil_printf("dut3_pattern6_CC1_0.8V_Calibration\r\n");
			////xil_printf("dut3.g_ccdet_calibration_data_buf[6] = %x\r\n",dut3.g_ccdet_calibration_data_buf[6]);
			////xil_printf("dut3.g_ccdet_calibration_data_buf[7] = %x\r\n",dut3.g_ccdet_calibration_data_buf[7]);
		}
			////////xil_printf("dut3_pattern6_CC1_0.8V_Calibration\r\n");
	...
	case 0x0006:
	{
		...
		else
		{
			...
			dut3.g_pattern_step = 0;
			//xil_printf("dut3.g_ccdet_step = %x\r\n",dut3.g_ccdet_step);
			////xil_printf("dut3_pattern6_CC2_0.8V_Calibration\r\n");
			////xil_printf("dut3.g_ccdet_calibration_data_buf[6] = %x\r\n",dut3.g_ccdet_calibration_data_buf[6]);
			////xil_printf("dut3.g_ccdet_calibration_data_buf[7] = %x\r\n\r\n",dut3.g_ccdet_calibration_data_buf[7]);
		}
			////////xil_printf("dut3_pattern6_CC2_0.8V_Calibration\r\n");
	...
	case 0x0007:
	{
		...
		else
		{
			...
			dut3.g_pattern_step = 0;
			xil_printf("dut3.g_ccdet_step = %x\r\n",dut3.g_ccdet_step);
			////xil_printf("dut3_pattern6_CC1_0.66V_Calibration\r\n");
			////xil_printf("dut3.g_ccdet_calibration_data_buf[6] = %x\r\n",dut3.g_ccdet_calibration_data_buf[6]);
	...
	case 0x0008:
	{
		...
		else
		{
			...
			dut3.g_pattern_step = 0;
			//xil_printf("dut3.g_ccdet_step = %x\r\n",dut3.g_ccdet_step);
			////xil_printf("dut3_pattern6_CC2_0.66V_Calibration\r\n");
			////xil_printf("dut3.g_ccdet_calibration_data_buf[6] = %x\r\n",dut3.g_ccdet_calibration_data_buf[6]);
			////xil_printf("dut3.g_ccdet_calibration_data_buf[7] = %x\r\n",dut3.g_ccdet_calibration_data_buf[7]);
		}
			////////xil_printf("dut3_pattern6_CC2_0.66V_Calibration\r\n");
	...
	case 0x0009:
	{
		...
		dut3.g_ccdet_phy_calibration_addr_buf[0] = 0x11;
		dut3.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut3.g_ccdet_voltage_sel = 0x00;
		...
		////////xil_printf("dut3_pattern6_CC1_1.23V_Calibration_before\r\n");
		_ccdet_calibration_dut3();
		if(dut3.g_ccdet_process_bit != ccdet_process_done_pass)
		{
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC1_1.23V_Calibration\r\n");
		    break;
	}
	...
	case 0x000a:
	{
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC2_1.23V_Calibration\r\n");
		    break;
	}
	...
	case 0x000b:
	{
		...
		dut3.g_dac_data_buf[3] = 0xf4;
		dut3.g_dac_data_buf[4] = 0x0b;
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC1_1.6V_Calibration\r\n");
		    break;
	}
	...
	case 0x000c:
	{
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC2_1.6V_Calibration\r\n");
		    break;
	}
	...
	case 0x000d:
	{
		...
		dut3.g_ccdet_phy_calibration_addr_buf[0] = 0x12;
		dut3.g_ccdet_phy_calibration_addr_buf[1] = 0x01;
		dut3.g_ccdet_voltage_sel = 0xff;
		...
		else
		{
			...
			////////xil_printf("dut3_pattern6_CC1_2.6V_Calibration\r\n");
		    break;
	}
	...
	case 0x000e:
	{
		...
		else
		{
			...
			dut3.g_pattern_step = 0;
      		...
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[4] =%x\r\n", dut3.g_ccdet_calibration_data_buf[4]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[5] =%x\r\n", dut3.g_ccdet_calibration_data_buf[5]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[6] =%x\r\n", dut3.g_ccdet_calibration_data_buf[6]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[7] =%x\r\n", dut3.g_ccdet_calibration_data_buf[7]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[8] =%x\r\n", dut3.g_ccdet_calibration_data_buf[8]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[9] =%x\r\n", dut3.g_ccdet_calibration_data_buf[9]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[10] =%x\r\n", dut3.g_ccdet_calibration_data_buf[10]);
      		//xil_printf("dut3.g_ccdet_calibration_data_buf[11] =%x\r\n\r\n", dut3.g_ccdet_calibration_data_buf[11]);
		}
		break;
	}
	...
	case 0x000f:
	{
		if(((dut3.g_ccdet_calibration_data_buf[4]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[4]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
		{
			...
			//xil_printf("dut3_g_ccdet_writeefuse fail, not fit spec!\r\n");
		}
		break;
	}
	...
	case 0x0010:
	{
		if((((dut3.g_ccdet_calibration_data_buf[4]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[4]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0011:
	{
		if(((dut3.g_ccdet_calibration_data_buf[5]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[5]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0012:
	{
		if((((dut3.g_ccdet_calibration_data_buf[5]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[5]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0013:
	{
		if(((dut3.g_ccdet_calibration_data_buf[6]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[6]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0014:
	{
		if((((dut3.g_ccdet_calibration_data_buf[6]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[6]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0015:
	{
		if(((dut3.g_ccdet_calibration_data_buf[7]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[7]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0016:
	{
		if((((dut3.g_ccdet_calibration_data_buf[7]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[7]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0017:
	{
		if(((dut3.g_ccdet_calibration_data_buf[8]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[8]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0018:
	{
		if((((dut3.g_ccdet_calibration_data_buf[8]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[8]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x0019:
	{
		if(((dut3.g_ccdet_calibration_data_buf[9]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[9]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x001a:
	{
		if((((dut3.g_ccdet_calibration_data_buf[9]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[9]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x001b:
	{
		if(((dut3.g_ccdet_calibration_data_buf[10]&0x0f)>ccdet_writeefuse_min)&&((dut3.g_ccdet_calibration_data_buf[10]&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x001c:
	{
		if((((dut3.g_ccdet_calibration_data_buf[10]>>4)&0x0f)>ccdet_writeefuse_min)&&(((dut3.g_ccdet_calibration_data_buf[10]>>4)&0x0f)<ccdet_writeefuse_max))
		{
			dut3.g_ccdet_step++;
		}
		else
	...
	case 0x001d:
	{
		dut3.g_dac_data_buf[0] = 0;
		dut3.g_dac_data_buf[1] = 0;
		dut3.g_dac_data_buf[2] = 0;
		dut3.g_dac_data_buf[3] = 0;
		dut3.g_dac_data_buf[4] = 0;
		dut3.g_dac_data_buf[5] = 0;
		dut3.g_dac_data_buf[6] = 0;
		...
		xil_printf("dut3_pattern6_CC_Calibration_pass!\r\n\r\n");
	...
	if(dut3.g_result_fail == 0x01)
	{
		...
		xil_printf("dut3_pattern6_fail! fail_step = %x\r\n\r\n",dut3.g_ccdet_step);
	}

	//////xil_printf("dut3.g_pattern_step = %x\r\n",dut3.g_pattern_step);
	////xil_printf("dut3_pattern6_ccdet_step = %x\r\n\r\n",dut3.g_ccdet_step);
	   return 0;
}

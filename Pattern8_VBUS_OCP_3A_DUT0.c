...
u8 _by_Pattern8_VBUS_OCP_3A_dut0()
{
	...
	case 0x0000:
	{
		...
		dut0.g_vbusocp_3a_nmos_control = 1;
		...
		{
			dut0.g_vbusocp_writeefuse_3a = dut0.g_vbus_ocp_calibrationdata_buf[1];
			dut0.g_vbusocp_process_bit = vbusocp_process_waiting;
			dut0.g_vbusocp_step=0;
			if((dut0.g_vbusocp_writeefuse_3a>VBUSOCP_Efuse_3a_Min)&&(dut0.g_vbusocp_writeefuse_3a<VBUSOCP_Efuse_3a_Max))
			{
				dut0.g_pattern_step++;
			}
			else
			{
				...
				xil_printf("dut0.g_vbusocp_writeefuse_3a = %x VBUSOCP_Efuse_3a_Min=%x VBUSOCP_Efuse_3a_Max=%x\r\n",dut0.g_vbusocp_writeefuse_3a,VBUSOCP_Efuse_3a_Min,VBUSOCP_Efuse_3a_Max);
				xil_printf("dut0_g_vbusocp_writeefuse_3a fail,not fit spec!\r\n");
			}
			//////xil_printf("dut0.g_vbusocp_step = %x\r\n",dut0.g_vbusocp_step);
	...
	case 0x0001:
	{
		...
		xil_printf(">>>>>>>>>>>> dut0_pattern8_vbus_ocp_3a_test_pass! <<<<<<<<<<<<\r\n");
		xil_printf("dut0_efuse_3a=0x%x\r\n\r\n",dut0.g_vbusocp_writeefuse_3a);
	...
	if(dut0.g_result_fail == 0x01)
	{
		...
		xil_printf("dut0_pattern8_fail! fail_pattern_step = %x    g_vbusocp_step=%x\r\n\r\n",dut0.g_pattern_step,dut0.g_vbusocp_step);
	}

...
//dut2 Pattern 8£ºRP Calibration and test
u8 _by_Pattern9_RP_36k_dut2()
{
	u8 i;
	u16 voltage_ldo3v3;
	u16 rp36k_ref;
	...
	case 0x0100:
	{
		   ...
		   //////////////xil_printf("\r\n dut2_pattern8_0xC1AE_be_writen\r\n");
		   //////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
		   break;
	}
	...
	case 0x0101:
	{
		   ...
		   //////////////xil_printf("dut2_pattern8_0xC108_be_writen\r\n");
		   //////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
		   break;
	}
	...
	case 0x0102:
	{
		   ...
		   //////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
		   //////////////xil_printf("dut2_pattern8_0x1022/1023_be_writen\r\n\r\n");
		   break;
	}
	...
	case 0x0103:
	{
		...
		//////xil_printf("dut2_pattern8_write_0x1131_with_0xc0\r\n");
		break;
	}
	   /****************************************
	...
	{
		msdelay(100);
		//_byAD7994ReadCvsData_dut2(0x05, 5);
    	...
    	dut2.g_dut_pattern_status_buf[11] = (rp36k_ref & 0xFF);
    	dut2.g_dut_pattern_status_buf[12] = (rp36k_ref & 0xFF00)>>8;
    	dut2.g_dut_pattern_status_buf[13] = (rp36k_min & 0xFF);
    	dut2.g_dut_pattern_status_buf[14] = (rp36k_min & 0xFF00)>>8;
    	dut2.g_dut_pattern_status_buf[15] = (rp36k_max & 0xFF);
    	dut2.g_dut_pattern_status_buf[16] = (rp36k_max & 0xFF00)>>8;

    	dut2.g_pattern_step++;
		//////////////xil_printf("dut2_pattern8_read_LDO3V3\r\n\r\n");
    	//////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
		break;
	}
	...
	case 0x0201:
	{
    	...
    	//////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
    	//////////////xil_printf("dut2_pattern8_write_0x106_default_data\r\n");
		break;
	}
	...
	case 0x0202:
	{
    	...
    	rp36k_ref = (u16)(dut2.g_dut_pattern_status_buf[12]<<8 | dut2.g_dut_pattern_status_buf[11]);
    	rp36k_min = (u16)(dut2.g_dut_pattern_status_buf[14]<<8 | dut2.g_dut_pattern_status_buf[13]);
    	rp36k_max = (u16)(dut2.g_dut_pattern_status_buf[16]<<8 | dut2.g_dut_pattern_status_buf[15]);
    	...
    	dut2.g_pattern_step++;
    	//////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
    	//////////////xil_printf("dut2_pattern8_read_cc1_rp36k_default_voltage\r\n");
    	break;
	}
	...
	case 0x0203:
	{
		...
		else
		{
		   ...
		   //////xil_printf("dut2_pattern8_step = %x\r\n", dut2.g_pattern_step);
		//////////////xil_printf("dut2_pattern8_write_cc1_rp36k_0x106\r\n");
		break;
	}
    	...
    	if((dut2.g_dut_pattern_status_buf[31] >= 0) && (dut2.g_dut_pattern_status_buf[31]<= 0x0F))
    	{
    		...
    		else if(cc1_rp_voltage < rp36k_ref)
    		{
				...
				dut2.g_pattern_step++;
    				...
    				//////////////xil_printf("dut2_pattern8_read_cc1_rp36k_calibration_voltage\r\n");
			    break;
    			}
	...
	case 0x0205:
	{
		   ...
		   ////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
		   //////////////xil_printf("dut2_pattern8_write_cc1_rp36k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0206:
	{
		   ...
		   {
		       cc1_rp36k_offset = (((dut2.g_pattern_smbus_control_buf[11] << 8) | (dut2.g_pattern_smbus_control_buf[10]))>>5)&0x1f;
		       if(cc1_rp36k_offset >= 0x0f)
		       {
		    	   dut2.g_dut_pattern_status_buf[30] = 0;
		    	   dut2.g_dut_pattern_status_buf[31] = cc1_rp36k_offset - 0x0f;
		    	   dut2.g_efuse_data_buf[7] = 1;
		    	   dut2.g_efuse_data_buf[8] = dut2.g_dut_pattern_status_buf[30];
		    	   dut2.g_efuse_data_buf[9] = dut2.g_dut_pattern_status_buf[31];
		       }
		       else if(cc1_rp36k_offset < 0x0f)
		       {
		    	   dut2.g_dut_pattern_status_buf[30] = 1;
		    	   dut2.g_dut_pattern_status_buf[31] = 0x0f- cc1_rp36k_offset;
		    	   dut2.g_efuse_data_buf[7] = 1;
		    	   dut2.g_efuse_data_buf[8] = dut2.g_dut_pattern_status_buf[30];
		    	   dut2.g_efuse_data_buf[9] = dut2.g_dut_pattern_status_buf[31];
		       }
					...
					//xil_printf("dut2_cc1_rp36k_offset =%x\r\n", cc1_rp36k_offset);
		   }
		   ////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
		   ...
		   //////////////xil_printf("cc1_rp36k_voltage =%d\r\n", cc1_rp_voltage);
		   //////////xil_printf("dut2.g_efuse_data_buf[8] =%x\r\n", dut2.g_efuse_data_buf[8]);
		   //////////xil_printf("dut2.g_efuse_data_buf[9] =%x\r\n", dut2.g_efuse_data_buf[9]);
		   //////////////xil_printf("dut2_pattern8_read_cc1_rp36k_calibration_0x106\r\n");
	break;
	}
	...
	case 0x0300:
	{
		  ...
		  smbus2_irq_handle(dut2.g_pattern_smbus_control_buf);
		   ...
		   ////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
		   //////////////xil_printf("dut2_pattern8_write_cc2_rp36k_calibration_0x106\r\n");
	break;
	}
    	...
    	rp36k_max = (u16)(dut2.g_dut_pattern_status_buf[16]<<8 | dut2.g_dut_pattern_status_buf[15]);
	       ...
	       //////////////xil_printf("rp36k_max = %d\r\n",rp36k_max );
			...
			if((cc2_rp_voltage > rp36k_min) && (cc2_rp_voltage < rp36k_max))
			{
				...
				xil_printf("dut2_pattern9_rp_36k_test_pass!    rp36k_signbit= 0x%x  rp36k_offset=0x%x\r\n\r\n",dut2.g_efuse_data_buf[8],dut2.g_efuse_data_buf[9]);
			...
			////////////xil_printf("dut2_rp_g_pattern_step = %x\r\n", dut2.g_pattern_step);
			//////////////xil_printf("dut2_pattern8_read_cc2_rp36k_voltage\r\n");
			break;
	}
	}
	...
	if(dut2.g_result_fail == 0x01)
	{
		...
		xil_printf("dut2_pattern9_fail! fail_step = %x\r\n",dut2.g_pattern_step);
	    xil_printf("rp36k_min = %d rp36k_max = %d\r\n",rp36k_min, rp36k_max);
	    xil_printf("dut2_cc_rp_voltage = %d\r\n\r\n",cc_rp_voltage);
	}
	//xil_printf("dut2_pattern8_rp_step = 0x%x\r\n", dut2.g_pattern_step);
	return 0;
}

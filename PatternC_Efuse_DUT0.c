...
u8 _by_Pattern12_efuse_dut0()
{
	...
	case 0x0002:
	{
		...
		//dut0.g_efuse_temp_buf[7] = (dut0.g_vmon_writeefuse_1000mv[0]&0x3f);                    //efuse VBUS 1V   cal
		//dut0.g_efuse_temp_buf[8] = (dut0.g_vmon_writeefuse_2500mv[0]&0x3f);                    //efuse VBUS 2.5V cal                                                                        //g_efuse_data_buf[6]:rp databit
		//dut0.g_efuse_temp_buf[9] = (dut0.g_vmon_writeefuse_3000mv[0]&0x3f);                    //efuse VBUS 3V   cal

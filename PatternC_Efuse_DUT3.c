...
u8 _by_Pattern12_efuse_dut3()
{
	...
	{
		dut3.g_pattern_smbus_control_buf[1] = smbus_cmd_type_readefuse;
		dut3.g_pattern_smbus_control_buf[2] = 0x1f;
		dut3.g_pattern_smbus_control_buf[3] = 0x00;
		...
		{
			//xil_printf("dut3.g_pattern_smbus_control_buf[10] =%x\r\n", dut3.g_pattern_smbus_control_buf[10]);
			//efuse_rp36k_valid   =  dut3.g_pattern_smbus_control_buf[10]&0x01;
	...
	case 0x0002:
	{
		...
		dut3.g_efuse_temp_buf[0] = ((QFN20_Package_Num<<4)|0x0f);                                //efuse validbit
		dut3.g_efuse_temp_buf[1] = (dut3.g_retest<<7|0x0c);                                      //efuse validbit

		dut3.g_efuse_temp_buf[2] = 0x40|dut3.g_efuse_data_ldo3v3;                                //efuse ldo3v3 data bit0~3		                                                                                         //efuse vbus ocp validbit
		dut3.g_efuse_temp_buf[3] = 0xe0;                                                         //efuse vmon comparitor                                                                                                //efuse vbus threshould
		dut3.g_efuse_temp_buf[4] = (dut3.g_efuse_data_buf[5]<<5 | dut3.g_efuse_data_buf[6]);     //efuse rp data                                                                                                //g_efuse_data_buf[5]:rp signbit
		dut3.g_efuse_temp_buf[5] = 0;
		dut3.g_efuse_temp_buf[6] = (dut3.g_vmon_writeefuse_600mv[0]&0x3f);                     	 //efuse VBUS 0.6V cal
		dut3.g_efuse_temp_buf[7] = (dut3.g_vmon_writeefuse_600mv[0]&0x3f);                    	 //efuse VBUS 1V   cal
		dut3.g_efuse_temp_buf[8] = (dut3.g_vmon_writeefuse_600mv[0]&0x3f);                    	 //efuse VBUS 2.5V cal                                                                        //g_efuse_data_buf[6]:rp databit
		dut3.g_efuse_temp_buf[9] = (dut3.g_vmon_writeefuse_600mv[0]&0x3f);                    	 //efuse VBUS 3V   cal
		//dut3.g_efuse_temp_buf[6] = 0x0f;                        							     //efuse VBUS 0.6V cal
		//dut3.g_efuse_temp_buf[7] = 0x0f;                                                       //efuse VBUS 1V   cal
		//dut3.g_efuse_temp_buf[8] = 0x0f;                                                       //efuse VBUS 2.5V cal                                                                        //g_efuse_data_buf[6]:rp databit
		//dut3.g_efuse_temp_buf[9] = 0x0f;                                                       //efuse VBUS 3V   cal
		...
		//dut3.g_efuse_temp_buf[25] = 0x06;                                                      //efuse vbus ocp 3A
		//dut3.g_efuse_temp_buf[26] = 0x10;                                                      //efuse vbus ocp 1.5A
		//dut3.g_efuse_temp_buf[27] = 0x1e;                                                      //efuse vbus ocp 0.9A
		dut3.g_efuse_temp_buf[25] = 0x07;                                						 //vbus ocp3A                                       //efuse vbus ocp 3A
		dut3.g_efuse_temp_buf[26] = dut3.g_vbusocp_writeefuse_1p5a;                              //vbus ocp1p5A                                                   //efuse vbus ocp 1.5A
		dut3.g_efuse_temp_buf[27] = dut3.g_vbusocp_writeefuse_1p5a;
		...
		dut3.g_efuse_temp_buf[30] = 0;
		dut3.g_efuse_temp_buf[31] = 0x01;
		dut3.g_efuse_temp_buf[32] = (dut3.g_efuse_data_buf[8]<<5 | dut3.g_efuse_data_buf[9]);    //efuse rp36k data
		dut3.g_efuse_temp_buf[33] = (dut3.g_efuse_data_buf[11]<<5 | dut3.g_efuse_data_buf[12]);  //efuse rp4.7k data
	...
	case 0x0003:
	{
		...
		//xil_printf("dut3_pattern0_write_efuse_data00_completed\r\n");
		break;
	}
	...
	case 0x0004:
	{
		   ...
		   //xil_printf("dut3_pattern0_write_efuse_data01_completed\r\n");
	break;
	}
	...
	case 0x0005:
	{
		   ...
		   //xil_printf("dut3_pattern0_write_efuse_data02_completed\r\n");
		   break;
	}
	...
	{
		   dut3.g_pattern_smbus_control_buf[1] = smbus_cmd_type_writeefuse;
		   dut3.g_pattern_smbus_control_buf[2] = 0x1e;
		   dut3.g_pattern_smbus_control_buf[3] = 0x00;
		   dut3.g_pattern_smbus_control_buf[4] = 0x04;

		   for(i=0;i<4;i++)
		   {
			   dut3.g_pattern_smbus_control_buf[i+5] = dut3.g_efuse_temp_buf[i+30];
		   }
		   ...
		   else
		   {
			   for(i=0;i<4;i++)
			   {
				   //xil_printf("dut3.g_pattern_smbus_control_buf[i] =%x %x\r\n", dut3.g_pattern_smbus_control_buf[i+5],i+30);
			   }
		   ...
		   //xil_printf("dut3_pattern0_write_efuse_data03_completed\r\n");
	break;
	}
	...
	case 0x0007:
	{
		...
		else
		{
			...
			for(i=0;i<10;i++)
			{
				if(dut3.g_efuse_temp_buf[i] != dut3.g_pattern_smbus_control_buf[i+10]) //compare00~09
				{
					efuse_compare_bit = 1;
					dut3.g_result_fail = 0x01;
					dut3.g_result_fail_tmrcount = 0xffff;
	...
	case 0x0008:
	{
		...
		else
		{
			...
			for(i=0;i<10;i++)
			{
				if(dut3.g_efuse_temp_buf[i+10] != dut3.g_pattern_smbus_control_buf[i+10]) //compare10~19
				{
					efuse_compare_bit = 1;
					dut3.g_result_fail = 0x01;
					dut3.g_result_fail_tmrcount = 0xffff;
	...
	case 0x000a:
	{
		...
		else
		{
			for(i=0;i<4;i++)
			{
				//xil_printf("dut3.g_pattern_smbus_control_buf[i] =%x %x\r\n", dut3.g_pattern_smbus_control_buf[i+10],i+30);
			}
			for(i=0;i<4;i++)
			{
				//xil_printf("dut3.g_efuse_temp_buf[i] =%x %x\r\n", dut3.g_efuse_temp_buf[i+30],i+30);
			}
			for(i=0;i<4;i++)
			{
				if(dut3.g_efuse_temp_buf[i+30] != dut3.g_pattern_smbus_control_buf[i+10])
				{
					efuse_compare_bit = 1;
					dut3.g_result_fail = 0x01;
					dut3.g_result_fail_tmrcount = 0xffff;
	...
	case 0x0100:
	{
		   ...
		   else
		   {
			   ...
			   for(i=0;i<10;i++)
			   {
				   xil_printf("dut3.efuse_read[i] =%02x     i =%02d\r\n", efuse_read_buf[i],i);
			   }
			   for(i=0;i<10;i++)
			   {
				   //xil_printf("dut3.g_efuse_temp_buf[i] =%x %x\r\n", dut3.g_efuse_temp_buf[i],i);
			   ...
			   // ////xil_printf("dut3.efuse_compare_bit00 = %x\r\n\r\n",efuse_compare_bit);
			   ////////////LDO3V3 Tolerance Compare/////////////////
			   ...
			   // ////xil_printf("dut3.efuse_compare_bit01 = %x\r\n\r\n",efuse_compare_bit);
			   //////xil_printf("dut3.efuse_rp12k_tolerance = %x\r\n\r\n",efuse_rp12k_tolerance);
			   ////////////RP12K Tolerance Compare/////////////////
			  ...
			  // ////xil_printf("dut3.efuse_compare_bit02 = %x\r\n\r\n",efuse_compare_bit);
			   ////////////VBUS/VMON 0P6V Tolerance Compare/////////////////
			  ...
			  // ////xil_printf("dut3.efuse_compare_bit03 = %x\r\n\r\n",efuse_compare_bit);
			   ////////////VBUS/VMON 1V Tolerance Compare/////////////////
			  ...
			  // ////xil_printf("dut3.efuse_compare_bit04 = %x\r\n\r\n",efuse_compare_bit);
			   ////////////VBUS/VMON 2.5V Tolerance Compare/////////////////
			   ...
			   //////xil_printf("dut3.efuse_compare_bit05 = %x\r\n\r\n",efuse_compare_bit);
			   ////////////VBUS/VMON 3V Tolerance Compare/////////////////
			   //if(dut3.g_result_fail ==1)
			   //{
				   ////xil_printf("dut3_patternc_step9_compare_fail!\r\n\r\n");
			   //}
...
*/
	...
	case 0x0104:
	{
		...
		else
		{
			for(i=0;i<4;i++)
			{
				efuse_read_buf[i+30]=dut3.g_pattern_smbus_control_buf[i+10];
			}
...
/*
			...
			if(dut3.g_efuse_data_buf[8]==1)
			{
				if(((efuse_read_buf[32]>>5)&0x01) ==1)
				{
					if(dut3.g_efuse_data_buf[9]>(efuse_read_buf[32]&0x0f))
					{
						efuse_rp36k_tolerance=dut3.g_efuse_data_buf[9]-(efuse_read_buf[32]&0x0f);
					}
					else
					{
						efuse_rp36k_tolerance=(efuse_read_buf[32]&0x0f)-dut3.g_efuse_data_buf[9];
					}
			...
			//xil_printf("dut3.efuse_compare_bit01 = %x\r\n\r\n",efuse_compare_bit);
			//xil_printf("dut3.efuse_rp36k_tolerance = %x\r\n\r\n",efuse_rp12k_tolerance);
			////////////RP36K Tolerance Compare/////////////////

			////////////RP4.7K Tolerance Compare/////////////////
			if(dut3.g_efuse_data_buf[11]==1)
			{
				if(((efuse_read_buf[33]>>5)&0x01) ==1)
				{
					if(dut3.g_efuse_data_buf[12]>(efuse_read_buf[33]&0x0f))
					{
						efuse_rp4p7k_tolerance=dut3.g_efuse_data_buf[12]-(efuse_read_buf[33]&0x0f);
					}
					else
					{
						efuse_rp4p7k_tolerance=(efuse_read_buf[33]&0x0f)-dut3.g_efuse_data_buf[12];
					}
...
*/
	...
	case 0x0200:
	{
		...
		dut3.g_pattern_smbus_control_buf[3] = 0x00;
		dut3.g_pattern_smbus_control_buf[4] = 0x01;
		dut3.g_pattern_smbus_control_buf[5] = (QFN20_Package_Num<<4);  //0x20:RL6628 QFN20 package number
		...
		else
		{
			...
			{
				dut3.g_uartPatternNum = 0x0d; //FT1 test pass
			}
			result_output_for_v50(XPAR_AXI_GPIO_dut3_1_BASEADDR,dut3.g_uartPatternNum);
			//usdelay(100);

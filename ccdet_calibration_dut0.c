...
u8 _ccdet_calibration_dut0()
{
	...
	case 0x0002:
	{
    	...
    	//write to phy 0x10f/0x110/0x111/0x112 with default data
		   ...
		   else
		   {
			...
			//////////xil_printf("dut0_pattern5_write_0x10f/0x110/0x111/0x112_default_dataL= %x\r\n",dut0.g_ccdet_calibration_data_buf[0]);
			//////////xil_printf("dut0_pattern5_write_0x10f/0x110/0x111/0x112_default_dataH= %x\r\n",dut0.g_ccdet_calibration_data_buf[1]);
			////////xil_printf("dut0.g_pattern_step = %x\r\n",dut0.g_pattern_step);
		    break;
	}
	...
	case 0x0003:
	{
		   ...
		   dut0.g_pattern_smbus_control_buf[2] = 0x29;
		   dut0.g_pattern_smbus_control_buf[3] = 0x10;
		   dut0.g_pattern_smbus_control_buf[4] = 0x01;

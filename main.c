...
int main()
{
	...
	xil_printf("FT2 start!\r\nFPGA Version:RTS5444_ft_merge_release_bypass_3a_2021040801\r\n");
		...
		if(dut0.g_dut_start_ready == 1)
		{
			...
			else
			{
				...
				//{
					...
					case 0x07:
					{
						_by_Pattern7_VBUS_OCP_1p5A_dut0();
						break;
					}
					case 0x08:
					{
					...
					case 0x09:
					{
						_by_Pattern9_RP_36k_dut0();
						break;
					}
					case 0x0a:
					{
						_by_Pattern10_RP_4p7k_dut0();
						break;
					}
					case 0x0c:
					{
		...
		if(dut1.g_dut_start_ready == 1)
		{
			...
			else
			{
				...
				//{
					...
					case 0x07:
					{
						_by_Pattern7_VBUS_OCP_1p5A_dut1();
						break;
					}
					case 0x08:
					{
					...
					case 0x09:
					{
						_by_Pattern9_RP_36k_dut1();
						break;
					}
					case 0x0a:
					{
						_by_Pattern10_RP_4p7k_dut1();
						break;
					}
					case 0x0c:
					{
		...
		if(dut2.g_dut_start_ready == 1)
		{
			...
			else
			{
				...
				//{
					...
					case 0x07:
					{
						_by_Pattern7_VBUS_OCP_1p5A_dut2();
						break;
					}
					case 0x08:
					{
					...
					case 0x09:
					{
						_by_Pattern9_RP_36k_dut2();
						break;
					}
					case 0x0a:
					{
						_by_Pattern10_RP_4p7k_dut2();
						break;
					}
					case 0x0c:
					{
		...
		if(dut3.g_dut_start_ready == 1)
		{
			...
			else
			{
				...
				//{
					...
					case 0x07:
					{
						_by_Pattern7_VBUS_OCP_1p5A_dut3();
						break;
					}
					case 0x08:
					{
					...
					case 0x09:
					{
						_by_Pattern9_RP_36k_dut3();
						break;
					}
					case 0x0a:
					{
						_by_Pattern10_RP_4p7k_dut3();
						break;
					}
					case 0x0c:
					{
